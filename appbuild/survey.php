        ...
        <div class="tab-pane fade show active" id="tab_pane_first" role="tabpanel" aria-labelledby="tab_pane_first">
            <div class="p-4">
                ...
                <div class="row align-items-center mb-2">
                    ...
                    <div class="col-9">
                        <input type="email" id="customerMail" placeholder="" class="form-control">
                    </div>
                </div>
            ...
            <div class="p-4">
                ...
                <div class="row align-items-center mb-2">
                    <div class="col-6 text-right">
                        <label for="house_kind" class="pr-2">Ist Business</label>
                    </div>
                    <div class="col-6">
                        <form>
                            <div class="form-group">
                                <select class="form-control" id="house_kind">
                                    <option value="" disabled selected></option>
                                    <option value="house_kind_nobussiness">Privat</option>
                                    <option value="house_kind_isbussiness">Firma</option>
                                </select>
                            </div>
                        </form>
                    </div>
            ...
            <div class="p-4">
                ...
                <div class="photo-section mt-4">
                    ...
                    <div class="row" data-context="hausnummer">
                        ...
                        <div class="col-md-3">
                            <div class="photo-container">
                                <img id="hausnummer_preview3" src="images/noimageplaceholder.jpg" alt="Vorschau 3" class="img-fluid">
                            </div>
                        </div>
                    </div>
            ...
            <div class="p-4">
                ...
                <div class="mb-3">
                    <div class="alert alert-secondary" role="alert">
                        ...
                        <hr>
                        <p class="mb-0">Der Eigentümer wurde über das Ankommen des Tiefbauteams innerhalb von 3 bis 5 Arbeitstagen nach Durchführung der Hausbegehung-Arbeiten benachrichtigt. Wird diese Frist nicht eingehalten, wird der Kunde von dem Team, das die Anschlüsse ausführt, kontaktiert und rechtzeitig in Kenntnis gesetzt.</p>
                    </div>
                </div>
