				...
				ja: {
					...
					action: function () {
						...
						if ($("#fileupload" + uid).val().length !== 0) {
							...
							$.alert({
								title: "Fehler",
								content: "Kein Protokoll ausgewählt!",
								type: "red",
								theme: 'supervan'
							});
						}
					...
					action: function () {
						if ($("#option1").prop("checked")) {
							...
							$.ajax({
								...
								data: {
									func: "load_notatt",
									homeid: homeid // Übergeben Sie hier die homeid
								},
								...
								if (response !== 'found') {
									$.alert({
										title: "Klingelbeweis",
										content: 'Klingelbeweis <b>verpflichtend!</b><br>Zu dieser HomeID wurde kein Foto hochgeladen',
										type: "red",
										theme: 'supervan'
									});
								} else {
						...
						if ($("#option3").prop("checked")) {
							...
							if (comment.length == 0) {
								...
								return false;
							} else if (comment.length < 70) {
								$.alert({
									title: "Fehler",
									content: "Grund zu ungenau! Bitte detaliert beschreiben.",
									type: "red",
									theme: 'supervan'
								});
								return false;
