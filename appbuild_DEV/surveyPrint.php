  ...
  <div id="pagewrapper">
    ...
    <div id="bp_page_1" style="padding: 5mm">
      ...
      <table class="bp-table bp-noborder-top" style="">
        <tr class="bp-bg-b">
          ...
          <td class="bp-noborder-top" id="bp_housetyp"></td>
          <td class="bp-noborder-top bp-w20" style="white-space: nowrap">
            <b>Anzahl Wohneinheiten</b>
          </td>
          <td class="bp-noborder-top" id="bp_houseunits"></td>
        </tr>
      </table>
      <!-- New table -->
      <table class="bp-table bp-noborder-top" style="">
        ...
        <tr class="bp-bg-b bp-noborder-top">
          <td colspan="5" class="bp-noborder-top">
            <label style="margin-right: 20px">
              <input type="checkbox" name="verwalter" id="bp_check_verwalter" />
              <b>Verwalter</b>
            </label>
            <label style="margin-right: 20px">
              <input type="checkbox" name="eigentuemer" id="bp_check_eigentumer" />
              <b>Eigentümer</b>
            </label>
            <label>
              <input type="checkbox" name="bevollmaechtigter" id="bp_check_bevollmaechtigter" />
      ...
      <table class="bp-table bp-noborder-top" style="">
        ...
        <tr class="bp-bg-b">
          <td class="bp-noborder-top bp-w70">
            <label style="margin-right: 20px">
              <input type="checkbox" name="eigentuemer" id="bp_check_pronoun_herr" />
              <b>Herr</b>
            </label>
            <label style="margin-right: 20px">
              <input type="checkbox" name="eigentuemer" id="bp_check_pronoun_frau" />
              <b>Frau</b>
            </label>
            <label for="bp_text_titel"><b>Titel:</b></label>
            <input type="text" name="titel" id="bp_check_pronoun_titel" placeholder="" />
          </td>
      ...
      <table class="bp-table bp-noborder-top" style="">
        ...
        <tr class="bp-bg-b">
          <td class="bp-noborder-top bp-w70">
            <label style="margin-right: 20px">
              <input type="checkbox" name="eigentuemer" id="bp_check_pronoun_herr_tenant" />
              <b>Herr</b>
            </label>
            <label style="margin-right: 20px">
              <input type="checkbox" name="eigentuemer" id="bp_check_pronoun_frau_tenant" />
              <b>Frau</b>
            </label>
            <label for="bp_text_titel"><b>Titel:</b></label>
            <input type="text" name="titel" id="bp_check_pronoun_titel_tenant" placeholder="" />
          </td>
      ...
      <table class="bp-table bp-noborder-top" style="">
        ...
        <tr class="bp-bg-b">
          <td class="bp-w50" style="font-size: 14px">
            <input type="checkbox" id="HE_fall_1" name="HE_fall" /><label for="HE_fall_1">Fall 1: Hauseinführung unterirdisch, Kellergeschoss</label>
          </td>
          <td class="bp-w50" style="font-size: 14px">
            <input type="checkbox" id="HE_fall_2" name="HE_fall" /><label for="HE_fall_2">Fall 2: Hauseinführung unterirdisch,
              Erdreich-Erdgeschoss</label>
          </td>
        </tr>
        <tr class="bp-bg-b">
          <td class="bp-w50" style="font-size: 14px">
            <input type="checkbox" id="HE_fall_3" name="HE_fall" /><label for="HE_fall_3">Fall 3: Hauseinführung oberirdisch, Erdgeschoss</label>
          </td>
          <td class="bp-w50" style="font-size: 14px">
            <input type="checkbox" id="HE_fall_4" name="HE_fall" /><label for="HE_fall_4">Fall 4: Hauseinführung/Leerrohr vorhanden</label>
          </td>
        </tr>
      </table>
      ...
      <table class="bp-table bp-noborder-top" style="">
        ...
        <tr class="bp-bg-b bp-noborder-top">
          ...
          <td class="bp-noborder-top bp-10" style="text-align: center" id="bp_meter_main_trasse">
            <b>0</b>
          </td>
          ...
          <td class="bp-noborder-top bp-10" style="text-align: center" id="bp_meter_sub_hupta">
            <b>0</b>
          </td>
        </tr>
        <tr class="bp-bg-b bp-noborder-top">
          <td class="bp-noborder-top bp-w35"><b>Kabellänge zum HÜP</b></td>
          <td class="bp-noborder-top bp-10" style="text-align: center" id="bp_meter_main_tohup">
            <b>0</b>
          </td>
          <td class="bp-noborder-top bp-20" style="background-color: #fff">
            <b></b>
          ...
          <td class="bp-noborder-top bp-10" style="text-align: center" id="bp_meter_sub_reserve">
            <b>0</b>
          </td>
        </tr>
        <tr class="bp-bg-b bp-noborder-top">
          <td class="bp-noborder-top bp-w35"><b>Gesamtlänge</b></td>
          <td class="bp-noborder-top bp-10" style="text-align: center" id="bp_meter_main_total">
            <b>0</b>
          </td>
          <td class="bp-noborder-top bp-20" style="background-color: #fff">
            <b></b>
          ...
          <td class="bp-noborder-top bp-w35"><b>Gesamtlänge</b></td>
          <td class="bp-noborder-top bp-10" style="text-align: center" id="bp_meter_sub_total">
            <b>0</b>
          </td>
        </tr>
      </table>
        ...
        <div class="row align-items-center mb-2">
          <div class="col-12">
            <div class="bp-w100 bp-bg-dark">
              <b>Sonstige Anmerkungen und/oder relevante Informationen zur
                Hausbegehung:</b>
            </div>
            <textarea class="form-control" id="bp_commenttohbg" rows="5" placeholder="" style="width: 99%"></textarea>
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="bp_page_2" style="padding: 5mm">
      ...
      <div class="" style="border: 1px solid">
        <div class="bp-w100 bp-bg-b" style="text-align: center">
          <b>Trassenverlauf vom Gehweg zur Hauswand (Empfehlung, soweit
    ...
    <div id="bp_page_3" style="padding: 5mm">
      ...
      <div class="" style="border: 1px solid; margin-bottom: 20px">
        <div class="bp-w100 bp-bg-b" style="text-align: center">
          <b>Der Installationsplatz des HÜPs wurde im Haus festgelegt und
    ...
    <div id="bp_page_4" style="padding: 5mm">
      ...
      <div class="rowrow" style="justify-content: center;margin-bottom: 20px;">
        <div class="bp-w30" style="display: flex; justify-content: center; align-items: center; text-align: center; height: 135px; flex-direction: column; border: 1px solid;" id="bp_dateplace"></div>
        <div class="bp-w35" style="text-align: center; height: 135px; border: 1px solid" id="bp_sign_technician"></div>
        <div class="bp-w35" style="text-align: center; height: 135px; border: 1px solid" id="bp_sign_customer"></div>
      </div>
      <div class="" style="margin-bottom: 20px;">
        <div class="bp-bg-dark" style="border: 1px solid;padding: 8px;">
          Datenschutzhinweis
        </div>
        <div class="bp-bg-b" style="border: 1px solid;border-top: none;padding: 8px;">
